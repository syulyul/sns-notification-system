...
VALUES
    (1, '첫 번째 회원의 상태 메시지입니다.', '1990-01-01', 1, 50, 100, NOW()),
    (2, 'This is the second user''s status message.', '1985-03-15', 2, 40, 90, NOW()),
    (3, '세 번째 회원의 상태 메시지입니다.', '1992-07-20', 1, 60, 110, NOW()),
    (4, 'Status message of the fourth user.', '1988-05-10', 2, 70, 120, NOW()),
    (5, '다섯 번째 회원의 상태 메시지입니다.', '1995-12-25', 1, 45, 95, NOW()),
    (6, 'This is the sixth user''s status message.', '1987-09-30', 2, 55, 105, NOW()),
    (7, '일곱 번째 회원의 상태 메시지입니다.', '1993-04-12', 1, 65, 115, NOW()),
    (8, 'Status message of the eighth user.', '1986-11-08', 2, 75, 125, NOW()),
